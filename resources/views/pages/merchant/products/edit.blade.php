...
@section('content')
    <div class="card" style="max-width: 550px">
        <div class="card-content">
            <div class="card-body">
                <h4 class="fs-4 fw-bold mb-3">Form Edit Produk</h4>
                <form action="{{route('pages.merchant.products.update', $product->id)}}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <img src="{{asset('storage/'.$product->image)}}" alt="{{$product->name}}" width="100px" class="mb-3 img-thumbnail d-block">
